...
public class RestaurantApp {
    ...
    // ============================
    // Confirm Order and Print Receipt (confirmation BEFORE printing)
    // ============================
    public static void confirmOrder() {
        ...
        // عرض الطلب الحالي للمراجعة
        System.out.println("\n======= Current Order Summary =======");
        showCurrentOrder();

        // مرحلة التأكيد قبل الطباعة
        System.out.print("\nDo you want to confirm the order? (1. Yes / 2. No): ");
        String confirm = input.nextLine();
        ...
        if (confirm.equals("1")) {
            ...
            System.out.println("======= Al-Nakheel Restaurant =======");
            printReceipt();

            System.out.println("\nThank you for choosing Al-Nakheel Restaurant!");
            orderList.clear(); // تفريغ الطلب بعد الطباعة
        } else {
            System.out.println("\nOrder not confirmed.");
        }
    }
